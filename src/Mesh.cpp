...
Mesh::Mesh(VkPhysicalDevice newPhysicalDevice, vkx::Device newDevice,
...
Model Mesh::getModel() { return model; }

int Mesh::getTexId() { return texId; }

int Mesh::getVertexCount() { return vertexCount; }

vkx::Buffer Mesh::getVertexBuffer() { return vertexBuffer; }
...
void Mesh::createVertexBuffer(VkQueue transferQueue,
  ...
  vkUnmapMemory(device,
		stagingBufferMemory); // 4. Unmap the vertex buffer memory
